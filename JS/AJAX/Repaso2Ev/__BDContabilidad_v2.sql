...
VALUES
    (1, 'Ingreso', 120.12 , 'Nómina', '2022/01/22', 39),
    (2, 'Ingreso', 1200.12 , 'Devolución', '2022/01/22', 38),
    (3, 'Gasto', -120.12 , 'Gasto gas', '2022/11/01', 3),
    (4, 'Gasto', -50.12 , 'Gasto comida', '2022/11/01', 6),
    (5, 'Gasto', -60.12 , 'Gasto ropa', '2022/10/01', 7),
    (6, 'Gasto', -70.12 , 'Gasto gasolina', '2022/10/01', 8),
    (7, 'Gasto', -220.12 , 'Gasto comida', '2022/10/01', 6),
    (8, 'Gasto', -90.12 , 'Gasto ropa', '2022/11/11', 7)
;
