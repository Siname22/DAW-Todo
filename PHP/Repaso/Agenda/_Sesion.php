...
session_start();
    ...
    function entrarSiSesionIniciada() {
        if (haySesionRAM()) redireccionar("Personas_Index_Ivan_Fernandez_Barco.php");
    }

    function salirSiSesionFalla() {
        if (!haySesionRAM()) redireccionar("Formulario_Inicia_Sesion_Ivan_fernandez_Barco.php?error");
    }
